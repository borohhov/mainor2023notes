...
class NoteRowWidget extends StatelessWidget {
  const NoteRowWidget({Key? key, required this.note, required this.position}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: ()=>Navigator.of(context).pushNamed('/note-screen', arguments: position),
      child: Padding(
